# Mais TI
O Projeto MaisTI capacitará mil novos profissionais por meio de dois cursos de curta duração na área de Tecnologia da Informação (TI): Programador de Sistemas de Informação e Técnico em Redes de Computadores.
...
O curso de Técnico em Redes de Computadores possui uma carga horária total de 200h, sendo composto por 4 disciplinas de 50h cada:
